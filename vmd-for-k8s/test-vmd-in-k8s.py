...
def exec_commands(api_instance,pod_name,namespace,input_file_name):
    name = 'ubuntu-desk-vmd-7989c5946d-fqsr8'
...
def main():
    ...
    exec_commands(core_v1,namespace,input_file_dir_name)

    cmd_for_log=r'echo "Please to visit http://192.168.108.109:30008 to use vmd for visualizatio! \n">>log.txt'
    os.system(cmd_for_log)
